...
export async function generateMetadata({
  ...
  return {
    ...
    description:
      "Driving ARR, NRR, and ACV growth through sharper bets, faster execution, and AI-native products and workflows. 15+ years scaling SaaS from early stage to $1B+ ARR.",
    alternates: {
